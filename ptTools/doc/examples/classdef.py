...
~~~~~~~~~~~~~~~~~~
 ...
 (In fact, ``Tup(classdef, more)`` would already match any class definition).
...
~~~~~~~~~~~~~~~~~
 ...
 >>> classnames = []
 ...
 >>> pattern = Tup(classdef, 'class', (NAME, _%classnames.append), more)%inc
 >>> pattern
 (329, (1, 'class'), (1, _), ~(_))
